 ...
 * @name        Thethao_Business_Match_Metadata_MatchStatistic
 * @author      QuangTM
 */
class Thethao_Business_Match_Metadata_MatchStatistic
{
    ...
    /**
     * @return Thethao_Business_Match_Metadata_MatchStatistic
     */
