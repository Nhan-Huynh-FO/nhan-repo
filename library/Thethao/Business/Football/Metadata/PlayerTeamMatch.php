 ...
 * @name        Fpt_Business_PlayerTeamMatch_Metadata_PlayerTeamMatch
 * @author      QuangTM
 */
class Thethao_Business_Football_Metadata_PlayerTeamMatch
{
     ...
     * Initialize data
     * @param array $entity
     * @return Fpt_Business_PlayerTeamMatch_Metadata_PlayerTeamMatch
     * @author QuangTM
     */
