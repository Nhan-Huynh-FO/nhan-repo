...
/**
 * @author      :   LamTX
 * @name        :   Thethao_Plugin_EnvM240
 * @version     :   201108
 * @copyright   :   FPT Online
 * @todo        :   Environment plugin
 * @return      :   Thethao_Plugin_EnvM240
 */
class Thethao_Plugin_EnvM240 extends Zend_Controller_Plugin_Abstract
{
    ...
    public function postDispatch(Zend_Controller_Request_Abstract $request)
    {
        ...
        if ($layout->isEnabled())
        {
            ...
            //unset menu Video
            unset($menu['child'][CATE_ID_VIDEO]);
