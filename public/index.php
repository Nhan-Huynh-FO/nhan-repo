...
// check method = POST when uri = / or index.php
if (($server_request_uri == '/' || $server_request_uri == '/index.php') && $_SERVER['REQUEST_METHOD'] != 'GET')
{
...
{
    //MT DEV
    require_once realpath('/home/phuongtn1/phpgiaitri/Fpt/Data/Mobile/Detect.php');
    //MT QC
...
set_include_path(implode(PATH_SEPARATOR, array(
    ...
    '/home/nhanht10/phpgiaitri',
    // '/home/nhuantp/framework',
    APPLICATION_PATH,
