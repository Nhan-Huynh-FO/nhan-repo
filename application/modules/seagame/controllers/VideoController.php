    ...
    public function indexAction()
    {
        ...
        if ($intVideoId <= 0)
        {
            ...
            $arrParams = array(
                ...
                'limit' => 1, //List 20 video / 1 page + video relate + 1 tin top
                'offset' => 0
            );
        ...
        else
        {
            ...
            {
                $sig = md5($intVideoId . $arrVideoInfo['creation_time']); //gen sig
        ...
        if (!empty($arrVideoInfo['list_tag_id']))
        {
            ...
            $arrParams = array(
                ...
                'site_id' => CATE_SEA_GAMES_VIDEO,
                'article_type' => TYPE_VIDEO,
                'limit' => LIMIT_RELATED_VIDEO + 1,
                'offset' => 0
            );
        ...
        if ($mRelateVideo < LIMIT_RELATED_VIDEO)
        {
            ...
            $arrParamsVideoRule2 = array(
                'category_id' => CATE_SEA_GAMES_VIDEO,
                'limit' => ( 2 * LIMIT_RELATED_VIDEO - $mRelateVideo) + 1,
                'offset' => 0
            );
        ...
        $arrParams = array(
            'category_id' => CATE_SEA_GAMES_VIDEO,
            'limit' => LIMIT_LIST_VIDEO + LIMIT_RELATED_VIDEO + 1, //Limit 20 video / 1 page + video relate + 1 video top
            'offset' => 0
        );
        //get all article by rule 2
        $arrListVideo = $objNews->getListArticleIdsByRule2($arrParams);
        ...
        $this->view->assign(array(
            'arrEx' => $videoExclude,
            'data' => $arrVideoInfo,
            'arrData' => $arrListVideo['data'],
            'arrVideoRelate' => $arrVideoRelate,
            'intArticleId' => $articleTrackingId,
            'intCategoryId' => CATE_SEA_GAMES_VIDEO,
            'notRefreshPage' => 1,
        ...
        if ($typeHTML == 'html5')
        {
            ...
            if (isset($arrData) && !empty($arrData))
            {
                $response = array(
                    ...
                    'thumbnail_url' => $this->view->ImageurlArticle($arrVideoInfo, 'size4')
                );
            }
            else
            {
