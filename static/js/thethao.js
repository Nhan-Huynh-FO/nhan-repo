...
var sendmail = {
            ...
            + '<form action="" name="send_mai" method="post">'
                ...
                + '<div class="share_email_des">'
                    ...
                    + '<div class="share_email_right">'
                        ...
                        + '<ul>'
                            + '<li class="active"><a href="' + base_url + '/" title="Thể thao">Thể thao</a></li>'
    ...
    var affFixture = {
		...
		next:function(startDate) {
			var startDate 	= startDate + 1 * 86400;
			var time = new Date('2014-12-20T23:59:59+07:00');
			var endDate 	=  time.getTime()/1000;
			console.log('next', startDate, endDate);
			affFixture.loadData(startDate, endDate, 'next');
		},
		previous: function(endDate) {
			var endDate 	= endDate - (1 * 86400);
			var time = new Date('2014-11-22T00:00:00+07:00');
			var startDate 	=  time.getTime()/1000;
			console.log('pre', startDate, endDate);
			affFixture.loadData(startDate, endDate, 'prev');
