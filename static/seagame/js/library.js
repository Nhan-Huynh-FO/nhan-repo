        ...
        core = {
            ...
            fixArgs: function (args) {
                ...
                return {
                    id: id,
                    deps: deps || [],
                    res: defFuncArity >= 0 ? defFunc : function () {
                        return defFunc;
                    },
                    cjs: cjs
                };
    ...
    (function (global, doc) {
        ...
        if ('addEventListener' in global) {
            addEvent = function (node, event) {
                ...
                return function () {
                    node.removeEventListener(event, checkDOMReady, false);
                };
            };
        }
        else {
            addEvent = function (node, event) {
                ...
                return function () {
                    node.detachEvent(event, checkDOMReady);
                };
            };
        }
